...
import { StatApi, type MLBSeasonTeamStat } from '@stat-api/client'
...
const rows: MLBSeasonTeamStat[] = []
for await (const row of api.mlb.season_team_stats.iter({ season_id: season })) rows.push(row)
