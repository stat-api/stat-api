...
// Find a game
var games = (await client.Nfl.Games.ListAsync(new NflGamesListParams { SeasonId = season, Limit = 1 })).Rows;

// Pull per-player stats for that game
var stats = (await client.Nfl.GamePlayerStats.ListAsync(new NflGamePlayerStatsListParams { GameId = games[0].Id })).Rows;
