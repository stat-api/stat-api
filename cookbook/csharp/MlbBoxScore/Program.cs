...
// Find a game
var games = (await client.Mlb.Games.ListAsync(new MlbGamesListParams { SeasonId = season, Limit = 1 })).Rows;

// Pull per-player stats for that game
var stats = (await client.Mlb.GamePlayerBatterStats.ListAsync(new MlbGamePlayerBatterStatsListParams { GameId = games[0].Id })).Rows;
